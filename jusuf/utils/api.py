...
from service_account.settings import JUSUF_USER as USER
from service_account.settings import JUSUF_PASSWORD as PASSWORD

import requests


ROOT_URL = 'https://zam2125.zam.kfa-juelich.de:9112/JUSUF/rest/core'
